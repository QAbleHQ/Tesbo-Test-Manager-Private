  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <div>
          <h2 className="text-base font-semibold text-[var(--foreground)]">Manage Admins</h2>
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--muted)]">
          Platform administrators who can access and manage workspace-level settings.
        </p>
      </div>
      ...
      {isOwner && (
        <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface)] p-5">
          <h3 className="text-[15px] font-semibold text-[var(--foreground)] mb-3">
            Add Platform Admin
          </h3>
